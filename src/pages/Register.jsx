...
export default function Register() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-3 sm:p-4 py-8 sm:py-10">
      ...
      >
        ...
        <h1 className="font-display text-xl sm:text-2xl font-bold text-center mb-1">Create your account</h1>
